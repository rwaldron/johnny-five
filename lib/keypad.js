  ...
  MPR121QR2: {
    ...
    initialize: {
      value: function(opts, dataHandler) {
        ...
        opts.sensitivity = opts.sensitivity || 40;
        ...
        this.sensitivity = {
          // Map approximately to 8 bit values:
          //
          // press: 12
          // release: 6
          //
          press: Array(12).fill(0.05),
          release: Array(12).fill(0.025),
        ...
        for (var i = 0; i < 12; i++) {
          this.io.i2cWrite(
            ...
            scale(this.sensitivity.press[i], 0, 1, 0, 255)
          );
          this.io.i2cWrite(
            address,
            this.REGISTER.ELE0_RELEASE_THRESHOLD + (i << 1),
            scale(this.sensitivity.release[i], 0, 1, 0, 255)
          );
        }
