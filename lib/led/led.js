...
Led.prototype.brightness = function(value) {
  ...
  if (typeof value === "object") {
    options = {
      duration: 1000,
      cuePoints: [0, 1.0],
      keyFrames: [null, { brightness: value.brightness || value.value }],
      oncomplete: function() {
        this.stop();
      }.bind(this)
    };
...
Led.prototype[Animation.normalize] = function(keyFrames) {
  ...
  keyFrames.forEach(function(keyFrame, i) {
    ...
    if (keyFrame !== null) {
      ...
      if (typeof keyFrame.brightness !== "undefined") {
        keyFrame.value = keyFrame.brightness;
      }
