...
function Led( opts ) {
  ...
  Object.defineProperties( this, {
    value: {
      get: function() {
        return ledMap.get( this ).value;
      }
    },
    isOn: {
      get: function() {
        return ledMap.get( this ).isOn;
      }
    }
  });
}
...
Led.prototype.pulse = function( time ) {
  ...
  this.interval = setInterval(function() {
    var valueAt = ledMap.get( this ).value;
...
Led.prototype.fade = function( val, time ) {
  ...
  var to = ( time || 1000 ) / ( (val || 255) * 2 ),
      direction = ledMap.get( this ).value <= val ? 1 : -1;
