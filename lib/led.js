  ...
  PCA9685: {
    ...
    ledWrite: {
      value: function() {
        ...
        this.io.sendI2CWriteRequest(this.address, [this.COMMANDS.LED0_ON_L + 4 * (this.pin), on, on >> 8, off, off >> 8]);
      }
    }
  },
  Standard: {
    ...
    ledWrite: {
      value: function() {
        ...
        if (value !== this.io.LOW && value !== this.io.HIGH && !this.board.pins.isPwm(this.pin)) {
          Board.Pins.Error({
            pin: this.pin,
            type: "PWM",
            via: "Led",
...
function Led(opts) {
  ...
  if (!opts || !opts.hasOwnProperty('controller')) {
    controller = Controllers["Standard"];
  }
  else if (typeof opts.controller === "string") {
