...
Led.RGB.prototype.color = function(red, green, blue) {
  ...
  if (
    update.red === null || update.red === undefined ||
    update.green === null || update.green === undefined ||
    update.blue === null || update.blue === undefined
  ) {
  ...
  Led.RGB.colors.forEach(function(color) {
    // constrain to [0,255]
    var value = Math.min(255, Math.max(0, update[color]));
