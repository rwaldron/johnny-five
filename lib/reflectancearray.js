...
function getLine(whiteLine) {
  ...
  if (!onLine) {
    var maxPoint = maxLineValue.bind(this)() + 1;
    var centerPoint = maxPoint/2;

    return priv.get(this).lastLine < centerPoint ? 0 : maxPoint;
  }

  return priv.get(this).lastLine = Math.floor(avg/sum);
}
...
function ReflectanceArray(opts) {
  ...
  Object.defineProperties(this, {
    ...
    isOnLine: {
      get: function() {
        var line = this.line;
        return line > CALIBRATED_MIN_VALUE && line < maxLineValue.bind(this)();
      }
    },
    sensors: {
      get: function() {
    ...
    values: {
      get: function() {
        return this.isCalibrated ? calibratedValues.bind(this)() : this.raw;
      }
    },
    line: {
      get: function() {
        return this.isCalibrated ? getLine.bind(this)() : 0;
      }
    }
  });
}
