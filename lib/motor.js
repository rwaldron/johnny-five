...
function updateShiftRegister(motor, dir) {
  var rKey = registerKey(motor.opts.register),
      ...
      switchPositions = { a: false, b: false },
      latchState = register.state;
  ...
  latchState = latch(latchState, priv.get(motor).bits.a, switchPositions.a);
  latchState = latch(latchState, priv.get(motor).bits.b, switchPositions.b);
