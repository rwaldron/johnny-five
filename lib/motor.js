  ...
  ShiftRegister: {
    ...
    updateShiftRegister: {
      value: function(register, dir) {
        var switchPositions = { a: false, b: false }; // off
        ...
        latchState = latch(latchState, this.bits.a, switchPositions.a);
        latchState = latch(latchState, this.bits.b, switchPositions.b);
