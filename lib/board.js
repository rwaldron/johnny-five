...
var Serial = {
  ...
  connect: function(portOrPath, firmataOpts, callback) {
    firmataOpts = firmataOpts || {};
    ...
    try {
      io = new IO(portOrPath, firmataOpts, function(error) {
        if (error) {
          caught = error;
        }
...
function Board(opts, firmataOpts) {
  ...
  if (opts.io) {
    ...
    if (this.port && opts.port) {
      Serial.connect.call(this, this.port, firmataOpts, finalizeAndBroadcast);
    } else {
      Serial.detect.call(this, function(path) {
        Serial.connect.call(this, path, firmataOpts, finalizeAndBroadcast);
      });
    }
  }
