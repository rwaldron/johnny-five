    ...
    initialize: {
      value: function(board, opts) {
        ...
        var readCycle = function() {
          ...
          // Send the appropriate command for this read cycle.
          ...
          setTimeout(function() {
            ...
            // but in reality, reading from 0x01
            io.i2cReadOnce(address, this.REGISTER.READ, 3, function(data) {
              ...
              if (isTemperatureCycle) {
                ...
                */
                ...
                | 7 | 6 | 5 | 4 | 3 | 2 | 1 | 0 | 7 | 6 | 5 | 4 | 3 | 2 | 1 | 0 |
                | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
                |    12-Bit Temperature Code                    | 0 | 0 | 0 | 0 |
                */

                computed.humidity = value >> 4;
              }
