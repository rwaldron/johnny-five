    ...
    initialize: {
      value: function(board, opts) {
        ...
        por.then(function() {
          ...
          io.i2cRead(address, this.REGISTER.READ.TEMP, this.REGISTER.LENGTH.TEMP, function(data) {
...
var Controllers = {
  ...
  BNO055: {
    ...
    components: {
      value: ["accelerometer", "gyro", "magnetometer", "thermometer", "euler", "quarternion"]
    },
    accelerometer: {
      get: function() {
        return priv.get(this).accelerometer;
