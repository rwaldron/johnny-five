...
const Drivers = {
  SHT31D: {
    ...
    initialize: {
      value(board, options) {
        const READLENGTH = 6;
        const io = board.io;
        const address = options.address || this.ADDRESSES[0];
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.SHT31D.ADDRESSES.value[0];
  ...
  HTU21D: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.HTU21D.ADDRESSES.value[0];
  ...
  HIH6130: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.HIH6130.ADDRESSES.value[0];
  ...
  DHT_I2C_NANO_BACKPACK: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.DHT_I2C_NANO_BACKPACK.ADDRESSES.value[0];
  ...
  MPU6050: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.MPU6050.ADDRESSES.value[0];
  ...
  BNO055: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.BNO055.ADDRESSES.value[0];
  ...
  MPL115A2: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.MPL115A2.ADDRESSES.value[0];
  ...
  MPL3115A2: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.MPL3115A2.ADDRESSES.value[0];
  ...
  BMP180: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.BMP180.ADDRESSES.value[0];
  ...
  BMP280: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.BMP280.ADDRESSES.value[0];
  ...
  BME280: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.BME280.ADDRESSES.value[0];
  ...
  SI7020: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.SI7020.ADDRESSES.value[0];
  ...
  MS5611: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.MS5611.ADDRESSES.value[0];
  ...
  TH02: {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.TH02.ADDRESSES.value[0];
        return `th02-${address}`;
      }
    }
  },
  ...
  LSM303C: {
    ...
    initialize: {
      value(board, options) {
        ...
        const initializeAccelerometer = () => {
          io.i2cConfig(Object.assign({}, options, { address: addresses.ACC }));
        ...
        const initializeMagnetometer = () => {
          io.i2cConfig(Object.assign({}, options, { address: addresses.MAG }));
        ...
        const readAccelerometer = done => {
          io.i2cReadOnce(addresses.ACC, this.REGISTER.ACC_OUTX_L, 6, data => {
        ...
        const readMagnetometer = done => {
          io.i2cReadOnce(addresses.MAG, this.REGISTER.MAG_OUTX_L, 6, data => {
        ...
        const readTemperature = done => {
          io.i2cReadOnce(addresses.MAG, this.REGISTER.MAG_TEMP_OUT_L, 2, data => {
    ...
    identifier: {
      value(options) {
        const address = options.address || Drivers.LSM303C.ADDRESSES.value[0];
  ...
  BNO055: {
    initialize: {
      value(options) {
        ...
        const driver = Drivers.get(this.board, CONTROLLER, options);
        driver.on("calibrated", () => {
          this.emit("calibrated");
        });

        driver.on("calibration", state => {
