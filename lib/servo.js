...
function Servo( opts ) {
  ...
  */];
  ...
  Object.defineProperties( this, {
    ...
    position: {
      get: function() {
        return this.history[ this.history.length - 1 ].degrees;
      }
    }
  });
...
Servo.prototype.move = function( degrees, time ) {
  ...
  if ( this.isInverted ) {
    degrees = Board.map(
      degrees, this.range[0], this.range[1], this.range[1], this.range[0]
    );
  }
  ...
  if ( typeof time !== "undefined" ) {
    ...
    this.interval = setInterval(function() {
      ...
      this.firmata.servoWrite( this.pin, last + delta );
...
[
  "center", "min", "max", "move", "stop", "sweep", "to"
