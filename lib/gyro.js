...
var Controllers = {
  ...
  MPU6050: {
    initialize: {
      value: function(opts, dataHandler) {
        var state = priv.get(this),
          driver = Board.Breakouts.get(this.board, "MPU-6050", opts);

        state.sensitivity = opts.sensitivity || 131;

        driver.on("data", function(err, data) {
          dataHandler.call(this, data.gyro);
        }.bind(this));
      }
    },
    toNormal: {
...
function Gyro(opts) {
  ...
  Object.defineProperties(this, {
    ...
    x: {
      get: function() {
        return ToPrecision(this.toNormal(state.x.value), 2);
      }
    },
    y: {
      get: function() {
        return ToPrecision(this.toNormal(state.y.value), 2);
      }
    },
    z: {
      get: function() {
        return state.z.hasValue ? ToPrecision(this.toNormal(state.z.value), 2) : undefined;
      }
    },
    rate: {
      get: function() {
