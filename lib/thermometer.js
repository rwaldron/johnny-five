...
var Controllers = {
  ...
  // OneWire protocol.  The device needs to be issued a "Convert Thermometer"
  ...
  HTU21D: {
    ...
    toCelsius: {
      value: function(raw) {
        // Based on the "Thermometer Conversion" formula
  ...
  GROVE: {
    ...
    toCelsius: {
      value: function(raw) {
        // http://www.seeedstudio.com/wiki/Grove_-_Thermometer_Sensor
        var adcres = 1023;
        // Beta parameter
        var beta = 3975;
