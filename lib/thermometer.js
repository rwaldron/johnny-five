...
const Controllers = {
  ...
  SHT31D: {
    initialize: {
      value(options, callback) {
        ...
        const driver = Multi.Drivers.get(this.board, "SHT31D", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
      value(raw) {
  ...
  HTU21D: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "HTU21D", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  HIH6130: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "HIH6130", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  DHT_I2C_NANO_BACKPACK: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "DHT_I2C_NANO_BACKPACK", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  TH02: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "TH02", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  MPL115A2: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "MPL115A2", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  SI7020: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "SI7020", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  LSM303C: {
    initialize: {
      value(options, callback) {
        const Multi = require("./imu");
        const driver = Multi.Drivers.get(this.board, "LSM303C", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
