...
const Controllers = {
  ...
  MPL115A2: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "MPL115A2", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  MPL3115A2: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "MPL3115A2", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  MS5611: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "MS5611", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  BMP180: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "BMP180", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  BMP280: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "BMP280", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
  ...
  LSM303C: {
    initialize: {
      value(options, callback) {
        const { Drivers } = require("./sip");
        const driver = Drivers.get(this.board, "LSM303C", options);
        driver.on("data", ({temperature}) => callback(temperature));
      }
    },
    toCelsius: {
