  ...
  SI7020: {
    ...
    toCelsius: {
      value: function(raw) {
        ...
        return +((175.72 * raw / 65536) - 46.85).toFixed(1);
      }
    }
  },
...
function Thermometer(opts) {
  ...
  var descriptors = {
    ...
    kelvin: {
      get: function() {
        return +(this.celsius + CELSIUS_TO_KELVIN).toFixed(2);
      }
    }
  };
  // Convenience aliases
