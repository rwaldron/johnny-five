...
function Button(opts) {
  ...
  longPress = typeof opts.longPress !== "undefined" ? opts.longPress : false;
  ...
  if (typeof this.initialize === "function") {
    this.initialize(opts, function(data) {
      ...
      if (this.isDown) {
        ...
        var longPressTime = this.longPress === true ? 1000 :
          Number.isInteger(this.longPress) ? this.longPress : 0;
