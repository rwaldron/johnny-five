...
Animation.prototype.enqueue = function(opts) {
  ...
  this.segments.push(Object.assign({}, Animation.DEFAULTS, opts));

  // TODO: For some reason, creating a stub for
  // - Animation.prototype.next
  // - animation.next
  //
  // Appears to be polluting the entire test
  /* istanbul ignore if */
  if (!this.paused) {
    this.next();
  }
