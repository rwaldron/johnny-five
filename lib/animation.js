...
// var tv = this.tweenedValue(indices, progress);

//   this.target[Animation.render](tv);
  ...
  /* istanbul ignore else */
  if ((this.progress === 1 && !this.reverse) || (progress === this.loopback && /* istanbul ignore next */ this.reverse)) {

    if (this.loop || (this.metronomic && /* istanbul ignore next */ !this.reverse)) {
...
Animation.prototype.play = function(flag) {
  var now = Date.now();
