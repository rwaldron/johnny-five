...
Object.keys(Relay.prototype).forEach(function(method) {
  // Create Relays wrappers for each method listed.
  // This will allow us control over all Relay instances
  // simultaneously.
  Relays.prototype[method] = function() {
