...
function Accelerometer( opts ) {
  ...
  this.axes.forEach(function( axis, index ) {
    var pair = this.get( "smooth", axis );
    changed[ index ] = pair[ 1 ] - pair[ 0 ];
  }, this );
  ...
  Object.defineProperties( this, {
    ...
    pitch: {
      get: function() {
        var x, y, z;
        x = this.get( "accel", "x", 1 );
        y = this.get( "accel", "y", 1 );
        z = this.axes.indexOf( "z" ) > -1 ? this.get( "accel", "z", 1 ): 0;
        return Math.abs(
          Math.atan2(
            x,
