...
// Sensor Constructor specific arrays
var sensors = [],
    states = [];

function updateState( sensor, state ) {
  states[ sensors.indexOf( sensor ) ] = state;
}
...
function Sensor( opts ) {
  ...
  Object.defineProperties( this, {
    ...
    scaled: {
      get: function() {
        var state = states[ sensors.indexOf( this ) ],
            scale, mapped, constrain;
