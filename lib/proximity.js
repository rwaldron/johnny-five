...
function analogHandler(options, dataHandler) {
...
const Controllers = {
  GP2Y0A21YK: {
    ...
    toCm: {
      value(raw) {
        return toFixed(12343.85 * (raw ** -1.15), 2);
      }
    }
  },
  GP2D120XJ00F: {
  ...
  GP2Y0A02YK0F: {
    ...
    toCm: {
      value(raw) {
        return toFixed(10650.08 * (raw ** -0.935) - 10, 2);
      }
    }
  },
  GP2Y0A41SK0F: {
  ...
  GP2Y0A710K0F: {
    ...
    toCm: {
      value(raw) {
        return toFixed(3.8631e8 * (raw ** -2.463343), 0);
      }
    }
  },
  SRF10: {
    initialize: {
      value(options, dataHandler) {
        ...
        const address = options.address || 0x70;
  ...
  HCSR04I2CBACKPACK: {
    initialize: {
      value(options, datahandler) {
        const address = options.address || 0x27;
