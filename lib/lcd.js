...
var Controllers = {
  JHD1313M1: {
    ...
    // @see http://www.mjkdz.com/forum.php?mod=viewthread&tid=2&highlight=I2C%2B1602
    MJKDZ: {
        ...
        initialize: {
            value: function(opts) {
                ...
                blocking: {
                    ...
                    this.expander.write(0x03 << 0); // 0011 0000
                    this.pulse(0x03 << 0);
                    sleep(4);

                    this.expander.write(0x03 << 0);
                    this.pulse(0x03 << 0);
                    sleep(4);
        ...
        pulse: {
            writable: true,
            value: function(data) {
                this.expander.write(data | this.OP.EN);
