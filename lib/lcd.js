...
var Controllers = {
  ...
  PCF8574: {
    ...
    initialize: {
      value: function(opts) {
        ...
        blocking: {
          ...
          //
          this.expander.write(0x03 << this.REGISTER.SHIFT_LEFT);
          this.pulse(0x03 << this.REGISTER.SHIFT_LEFT);
          sleep(4);
          ...
          this.expander.write(0x02 << this.REGISTER.SHIFT_LEFT);
          this.pulse(0x02 << this.REGISTER.SHIFT_LEFT);
          ...
          this.command(this.REGISTER.ENTRY | entry);
          this.backlight();
        }
      },
    },
    ...
    pulse: {
      writable: true,
      value: function(data) {
        this.expander.write(data | this.REGISTER.EN); // En HIGH
        this.expander.write(data & ~this.REGISTER.EN); // En LOW
      }
    }
  },
